...
<a class="btn-sm btn-success" href="sales_report.php">
  <i class="icon-plus"></i>
Show All Result
</a> 
...
$query="SELECT  tbl_sales.*,tbl_customer.customer_name FROM tbl_sales LEFT JOIN tbl_customer ON tbl_sales.customer_id=tbl_customer.id ORDER BY tbl_sales.id DESC ";
...
<script>  
  ...
  {  
       ...
       {  
            ...
            {  
                 $.ajax({  
                      url:"Ajax_filter_search/sales_report.php",  
                      method:"POST",  
