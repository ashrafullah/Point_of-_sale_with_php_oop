<?php include 'frontend_includes/header.php'; ?>
   <body>
      <div id="Home"></div>
      <div class="top-aria">
                     ...
                     <div class="main-menu">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                           <ul class="nav navbar-nav">
                              ...
                              <li class="smooth-menu"><a href="Login/index.php">Demo</a></li>
      ...
      <div class="price-aria section-padding" id="price">
        <div class="container">
          <div class="row">
            ...
            <br>
            <div class="col-md-6">
              <img src="Frontend-assets/images/admin-pos.png">
            </div>
            <div class="col-md-6">
              <div class="price">
                <h3>Price $200 USD</h3>
               ...
               <div class="col-md-6 col-sm-6">
                  ...
                  <ul class="contact-list">
                     ...
                     <li>
                        ...
                        <a href="ashrafullah274@gmail.com" target="blank">
                        ashrafullah274@gmail.com
                     </li>
                     <li>
                        <i class="fa fa-user"></i>
                        <a href="http://ashrafullah.phpbd4.com" target="blank">
                        ashrafullah.phpbd4.com
                        </a>
                     </li>
                     <li>
                        <i class="fa fa-facebook"></i>
                        <a href="https://www.facebook.com/ashrafullah274" target="blank">
                        facebook.com
                        </a>
                     </li>
                  </ul>
